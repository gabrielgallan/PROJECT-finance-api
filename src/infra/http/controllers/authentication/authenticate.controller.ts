...
export class AuthenticateResponseDTO extends createZodDto(z.object({ token: z.string() })) {}
...
export class AuthenticateController {
  ...
  @ApiBadRequestResponse({ type: ErrorResponseDto, description: 'Invalid credentials' })
  @ApiBadRequestResponse({ type: ErrorResponseDto, description: 'Invalid credentials' })
  async handle(
